...
fun FileBrowserScreen(
    ...
    var webAppSheetSource by remember { mutableStateOf<com.fug.openthumb.webapp.WebAppSource.HostFile?>(null) }
...
private fun FileItemRow(
    ...
    onClick: () -> Unit,
    onDelete: () -> Unit,
    onAddToHome: (com.fug.openthumb.webapp.WebAppSource.HostFile) -> Unit,
) {
    ...
    run {
        ...
        com.fug.openthumb.ui.components.MinisMenu(
            ...
            DropdownMenuItem(
                ...
                onClick = {
                    menuExpanded = false
                    val triple = com.fug.openthumb.webapp.WebAppPathResolver.inferScope(item.file)
                    if (triple != null) {
                        val (scope, ctx, linuxPath) = triple
                        onAddToHome(
                            com.fug.openthumb.webapp.WebAppSource.HostFile(
                                file = item.file,
                                fileName = item.name,
                                pathScope = scope,
                                scopeContext = ctx,
...
private fun MoreMenu(
    ...
    Box {
        ...
        com.fug.openthumb.ui.components.MinisMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
