...
/**
 * One configurable setting. Concrete kinds: [com.fug.openthumb.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.fug.openthumb.config.fields.ClosureField]
