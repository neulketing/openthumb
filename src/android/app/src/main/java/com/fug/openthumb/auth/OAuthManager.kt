package com.fug.openthumb.auth
...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun forInstance(context: Context, instance: com.fug.openthumb.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.fug.openthumb.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.fug.openthumb.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.fug.openthumb.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.fug.openthumb.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.fug.openthumb.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
