package com.fug.openthumb.ui.components
...
import com.fug.openthumb.data.model.normalizeModalityName
...
private suspend fun performTest(
    ...
    if (kind == QuickTestKind.SPEECH_OUT || kind == QuickTestKind.TRANSCRIPTION) {
        val voice = com.fug.openthumb.provider.voice.VoiceProviderFactory.make(instance, apiKey)
                ...
                if (!voice.supportsVoiceOutput) {
                    ...
                    runCatching {
                        ...
                        val data = voice.synthesize(
                            com.fug.openthumb.provider.voice.VoiceOutputRequest(
                ...
                if (!voice.supportsVoiceInput) {
                    ...
                    runCatching {
                        val resp = voice.transcribe(
                            com.fug.openthumb.provider.voice.VoiceInputRequest(
                                audioData = clip,
