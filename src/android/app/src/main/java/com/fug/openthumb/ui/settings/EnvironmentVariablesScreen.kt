...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.fug.openthumb.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.fug.openthumb.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
