package com.fug.openthumb.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.fug.openthumb.service.SessionActivityTracker]
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.fug.openthumb.service.SessionActivityTracker] when a
