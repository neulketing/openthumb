...
import com.fug.openthumb.data.db.ChatDao
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.fug.openthumb.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.fug.openthumb.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.fug.openthumb.share.ChatExporter]
