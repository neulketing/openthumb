...
import com.fug.openthumb.ui.components.PickerModalityFilter
import com.fug.openthumb.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.fug.openthumb.data.model.ModelEntry?>(null) }
    ...
    quickTestEntry?.let { entry ->
        com.fug.openthumb.ui.components.QuickTestSheet(
            entry = entry,
            providerRepository = providerRepository,
