...
import com.fug.openthumb.offload.ShizukuManager
...
fun OffloadPermissionScreen(
    ...
    val configEnabled by com.fug.openthumb.config.MinisConfigPermissionStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    com.fug.openthumb.config.MinisConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                MinisTextButton(onClick = {
                    ...
                    com.fug.openthumb.config.MinisConfigPermissionStore.setEnabled(true)
