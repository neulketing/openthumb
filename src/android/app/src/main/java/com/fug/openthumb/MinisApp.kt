...
import com.fug.openthumb.data.db.AppDatabase
import com.fug.openthumb.data.repository.BackgroundSettingsRepository
import com.fug.openthumb.data.repository.ChatRepository
import com.fug.openthumb.data.repository.EnvVarRepository
import com.fug.openthumb.data.MountedFoldersStore
import com.fug.openthumb.data.repository.MemoryRepository
import com.fug.openthumb.data.repository.ProviderRepository
import com.fug.openthumb.data.repository.WebAppShortcutRepository
import com.fug.openthumb.data.repository.MCPRepository
import com.fug.openthumb.data.repository.SkillRepository
import com.fug.openthumb.notification.BackgroundTaskNotifier
import com.fug.openthumb.logging.AppLogger
import com.fug.openthumb.network.NetworkMonitor
import com.fug.openthumb.offload.OffloadPermissionManager
import com.fug.openthumb.provider.ModelsDevApi
import com.fug.openthumb.sandbox.ExecutionCoordinator
import com.fug.openthumb.sandbox.MountedFolderCoordinator
import com.fug.openthumb.sandbox.NativeOffloadServer
import com.fug.openthumb.sandbox.PRootKernel
import com.fug.openthumb.sandbox.RootfsManager
import com.fug.openthumb.sandbox.offload.AccessibilityOffloadHandler
import com.fug.openthumb.sandbox.offload.AlarmOffloadHandler
import com.fug.openthumb.sandbox.offload.BrowserUseOffloadHandler
import com.fug.openthumb.sandbox.offload.CalendarOffloadHandler
import com.fug.openthumb.sandbox.offload.ClipboardOffloadHandler
import com.fug.openthumb.sandbox.offload.ContactsOffloadHandler
import com.fug.openthumb.sandbox.offload.DeviceOffloadHandler
import com.fug.openthumb.sandbox.offload.LocationOffloadHandler
import com.fug.openthumb.sandbox.offload.ModelUseOffloadHandler
import com.fug.openthumb.sandbox.offload.SessionsOffloadHandler
import com.fug.openthumb.sandbox.offload.ShizukuOffloadHandler
import com.fug.openthumb.sandbox.offload.NotificationOffloadHandler
import com.fug.openthumb.sandbox.offload.OpenOffloadHandler
import com.fug.openthumb.sandbox.offload.PhotosOffloadHandler
import com.fug.openthumb.sandbox.offload.PlayerOffloadHandler
import com.fug.openthumb.sandbox.offload.SpeakOffloadHandler
import com.fug.openthumb.sandbox.offload.SpeechOffloadHandler
import com.fug.openthumb.sandbox.offload.WeatherOffloadHandler
import com.fug.openthumb.service.SessionActivityTracker
import com.fug.openthumb.ui.MinisImageFetcher
...
class MinisApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.fug.openthumb.data.FastModePrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.fug.openthumb.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.fug.openthumb.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.fug.openthumb.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.fug.openthumb.diagnostics.LaunchCycleBeacon].
        try {
            com.fug.openthumb.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        com.fug.openthumb.diagnostics.HangDetector.start(this)
        ...
        com.fug.openthumb.agent.SoulStore.ensureExists(this)
        com.fug.openthumb.agent.SoulStore.refreshCache(this)
        ...
        com.fug.openthumb.config.MinisConfigPermissionStore.init(this)
        com.fug.openthumb.config.audit.ConfigAuditLog.init(this)
        com.fug.openthumb.config.ConfigRegistry.init(
        ...
        com.fug.openthumb.data.EnvVarPrivacyStore.init(this)
        com.fug.openthumb.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "minis-config",
            com.fug.openthumb.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "minis-scheduled",
            com.fug.openthumb.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        com.fug.openthumb.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "minis-debug",
                com.fug.openthumb.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        com.fug.openthumb.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.fug.openthumb.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = com.fug.openthumb.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        com.fug.openthumb.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.fug.openthumb.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.fug.openthumb.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.fug.openthumb.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        com.fug.openthumb.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                com.fug.openthumb.debug.DebugServer(this).start()
            } catch (e: Exception) {
    ...
    override fun onTerminate() {
        ...
        try {
            com.fug.openthumb.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {
