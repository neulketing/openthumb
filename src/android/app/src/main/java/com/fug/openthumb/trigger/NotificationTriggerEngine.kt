...
import com.fug.openthumb.scheduled.ScheduledAgentRunner
import com.fug.openthumb.scheduled.ScheduledRepeatMode
import com.fug.openthumb.scheduled.ScheduledTargetMode
...
object NotificationTriggerEngine {
    ...
    private fun recordStats(
        ...
        val ruleKind = rule?.let { com.fug.openthumb.trigger.stats.StatsEvent.ruleKindOf(it) } ?: "any"
        com.fug.openthumb.trigger.stats.StatsSink(
            java.io.File(context.filesDir, "stats"),
        ).append(
            com.fug.openthumb.trigger.stats.StatsEvent.triggerRun(
                ruleKind = ruleKind,
                appCategory = category,
                outcome = outcome,
                latencyBucket = com.fug.openthumb.trigger.stats.StatsEvent.durationBucket(
