package com.fug.openthumb.ui.navigation
...
import com.fug.openthumb.deeplink.DeepLinkAction
import com.fug.openthumb.deeplink.DeepLinkCoordinator
import com.fug.openthumb.ui.settings.KEY_LAUNCH_SESSION
import com.fug.openthumb.ui.settings.getAppearancePrefs
...
import com.fug.openthumb.ui.chat.ChatScreen
import com.fug.openthumb.ui.sessions.SessionListScreen
import com.fug.openthumb.ui.settings.AboutScreen
import com.fug.openthumb.ui.settings.AddAgentLoopGroupsScreen
import com.fug.openthumb.ui.settings.AddAgentLoopModelsScreen
import com.fug.openthumb.ui.settings.AddCustomModelScreen
import com.fug.openthumb.ui.settings.BackgroundSettingsScreen
import com.fug.openthumb.ui.settings.AddModelsToGroupScreen
import com.fug.openthumb.ui.settings.ShadowVoiceDetailScreen
import com.fug.openthumb.ui.settings.AddProviderScreen
import com.fug.openthumb.ui.settings.ModelEntryDetailScreen
import com.fug.openthumb.ui.settings.ModelGroupDetailScreen
import com.fug.openthumb.ui.settings.ModelGroupsScreen
import com.fug.openthumb.ui.settings.ProviderDetailScreen
import com.fug.openthumb.ui.settings.ProviderListScreen
import com.fug.openthumb.ui.sandbox.FileBrowserScreen
import com.fug.openthumb.ui.sandbox.FileBrowserViewModel
import com.fug.openthumb.ui.sandbox.FileItem
import com.fug.openthumb.ui.sandbox.FilePreviewScreen
import com.fug.openthumb.ui.sandbox.RootfsManagementScreen
import com.fug.openthumb.ui.settings.EnvironmentVariablesScreen
import com.fug.openthumb.ui.settings.AppearanceScreen
import com.fug.openthumb.ui.settings.SettingsScreen
import com.fug.openthumb.ui.settings.SystemPermissionsScreen
import com.fug.openthumb.ui.settings.SessionStorageDetailScreen
import com.fug.openthumb.ui.settings.SkillDetailScreen
import com.fug.openthumb.ui.settings.StorageManagementScreen
import com.fug.openthumb.ui.settings.SkillFileViewerScreen
import com.fug.openthumb.ui.settings.UsageStatsScreen
import com.fug.openthumb.ui.settings.MinisSkillsBrowserScreen
import com.fug.openthumb.ui.settings.MountDetailScreen
import com.fug.openthumb.ui.settings.MountedFoldersScreen
import com.fug.openthumb.ui.settings.SharedFolderDetailScreen
import com.fug.openthumb.ui.settings.SharedFoldersScreen
import com.fug.openthumb.ui.settings.SkillsManagementScreen
import com.fug.openthumb.data.repository.EnvVarRepository
import com.fug.openthumb.data.repository.MemoryRepository
import com.fug.openthumb.data.repository.SkillRepository
import com.fug.openthumb.ui.settings.LogDetailScreen
import com.fug.openthumb.ui.settings.LogManagementScreen
import com.fug.openthumb.ui.settings.MemoryFileEditScreen
import com.fug.openthumb.ui.settings.MemoryManagementScreen
import com.fug.openthumb.ui.settings.OffloadPermissionScreen
import com.fug.openthumb.ui.settings.ShizukuPermissionScreen
import com.fug.openthumb.sandbox.RootfsManager
import com.fug.openthumb.sandbox.TerminalSession
import com.fug.openthumb.ui.terminal.TerminalScreen
import com.fug.openthumb.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as com.fug.openthumb.MinisApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val mode = if (
            com.fug.openthumb.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            com.fug.openthumb.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            com.fug.openthumb.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        "shared" -> ctx.getString(com.fug.openthumb.R.string.shared_folder_name_shared)
                        "skills" -> ctx.getString(com.fug.openthumb.R.string.shared_folder_name_skills)
                        "memory" -> ctx.getString(com.fug.openthumb.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.fug.openthumb.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.fug.openthumb.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SYNC) {
            com.fug.openthumb.ui.settings.SyncSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.fug.openthumb.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.fug.openthumb.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.fug.openthumb.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
