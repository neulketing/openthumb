package com.fug.openthumb.scheduled
...
import com.fug.openthumb.debug.HeadlessChatRunner
import com.fug.openthumb.logging.AppLogger
import com.fug.openthumb.service.AgentForegroundService
    ...
    private suspend fun resolveSessionId(app: MinisApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = com.fug.openthumb.data.MemoryGlobalPrefs.isGlobalEnabled(app)
