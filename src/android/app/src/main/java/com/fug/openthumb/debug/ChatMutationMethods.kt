...
import com.fug.openthumb.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
     ...
     * [com.fug.openthumb.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.fug.openthumb.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.fug.openthumb.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.fug.openthumb.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.fug.openthumb.service.SessionActivityTracker.isActive(sessionId))
