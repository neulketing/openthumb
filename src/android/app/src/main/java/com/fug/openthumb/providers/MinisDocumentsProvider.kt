package com.fug.openthumb.providers
 ...
 *     android:authorities="com.fug.openthumb.documents"
...
class MinisDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.fug.openthumb.documents"
    ...
    override fun queryRoots(projection: Array<String>?): Cursor {
        ...
        cursor.newRow()
            ...
            .add(Root.COLUMN_TITLE, "OpenThumb")
    ...
    override fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        ...
        val displayName = if (documentId.isEmpty()) "OpenThumb" else file.name
        cursor.newRow()
