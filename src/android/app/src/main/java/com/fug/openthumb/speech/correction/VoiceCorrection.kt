package com.fug.openthumb.speech.correction

import android.content.Context
import android.util.Log
import com.fug.openthumb.MinisApp
import com.fug.openthumb.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        val dao = runCatching {
            com.fug.openthumb.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<com.fug.openthumb.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)
