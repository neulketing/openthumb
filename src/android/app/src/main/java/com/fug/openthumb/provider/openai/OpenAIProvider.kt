...
import com.fug.openthumb.provider.applyUserAgentOverride
...
import com.fug.openthumb.provider.failOnSilentEmptyCompletion
...
class OpenAIProvider private constructor(
    ...
    private val client = OkHttpClient.Builder()
        ...
        .connectionPool(com.fug.openthumb.network.NetworkMonitor.sharedLLMConnectionPool)
    ...
    private fun rawStreamMessage(
        ...
        if (!response.isSuccessful) {
            ...
            com.fug.openthumb.logging.AppLogger.error(
                "OpenAIProvider",
            ...
            if (com.fug.openthumb.BuildConfig.DEBUG) {
                com.fug.openthumb.debug.LLMRequestLog.add(
                    com.fug.openthumb.debug.LLMRequestLog.Entry(
                        provider = "openai",
                ...
                run {
                    ...
                    if (delta != null) {
                        ...
                        if (cLen + rcLen + rLen + tcLen > 0 || delta.has("role")) {
                            com.fug.openthumb.logging.AppLogger.debug(
                                "OpenAIProvider",
                                    ...
                                    when (part) {
                                        ...
                                        is AgentContentPart.ImageData -> {
                                            if (supportsImages) {
                                                ...
                                                val safeBytes = com.fug.openthumb.provider.ImageBudget.compressUnderBudget(part.data)
    ...
    private fun buildResponsesAPIBody(
        ...
        if (com.fug.openthumb.data.FastModePrefs.isEnabled() &&
