...
import com.fug.openthumb.browser.BrowserAction
import com.fug.openthumb.browser.BrowserActionInput
import com.fug.openthumb.browser.BrowserActionResult
...
class BrowserUseOffloadHandler(private val app: MinisApp) : NativeOffloadHandler {
    ...
    override fun handle(request: NativeOffloadRequest): NativeOffloadResult {
        ...
        com.fug.openthumb.service.SessionActivityTracker.updateToolStatus(
