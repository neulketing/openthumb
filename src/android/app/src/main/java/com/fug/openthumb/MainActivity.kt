...
import com.fug.openthumb.deeplink.DeepLinkHandler
import com.fug.openthumb.logging.AppLogger
import com.fug.openthumb.service.SessionActivityTracker
import com.fug.openthumb.ui.navigation.AppNavigation
import com.fug.openthumb.ui.navigation.Routes
import com.fug.openthumb.ui.navigation.safeNavigate
import com.fug.openthumb.ui.settings.KEY_FONT_APP_BASE
import com.fug.openthumb.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.fug.openthumb.ui.settings.KEY_LANGUAGE
import com.fug.openthumb.ui.settings.KEY_LAUNCH_SESSION
import com.fug.openthumb.ui.settings.KEY_THEME_MODE
import com.fug.openthumb.ui.settings.PREF_APPEARANCE
import com.fug.openthumb.ui.settings.getAppearancePrefs
import com.fug.openthumb.ui.settings.fontScaleForLevel
import com.fug.openthumb.ui.settings.keepScreenAwakeEnabled
import com.fug.openthumb.ui.theme.MinisTheme
...
class MainActivity : ComponentActivity() {
     ...
     * [com.fug.openthumb.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.fug.openthumb.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (com.fug.openthumb.crash.CrashFrequencyDetector.isSafeMode()) {
            ...
            com.fug.openthumb.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
                onClosed = { finish() },
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.fug.openthumb.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        if (intent?.getBooleanExtra("shared_content", false) == true) {
            com.fug.openthumb.share.ShareCoordinator.processPendingShare(this)
        }
        ...
        if (BuildConfig.DEBUG) {
            com.fug.openthumb.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.fug.openthumb.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.fug.openthumb.ui.navigation.AppNavigation]
