...
import com.neulketing.openthumb.ui.terminal.emulator.TerminalColor
...
fun TerminalCanvasView(
    ...
    val terminalTypeface = com.neulketing.openthumb.ui.terminal.rememberJetBrainsMonoTypeface()
